      ...
      hooks = {
        clang-format = {
          ...
          excludes = [
            ...
            ''^subprojects/libexpr/flake/config\.cc$''
            ''^subprojects/libexpr/flake/flake\.cc$''
            ''^subprojects/libexpr/flake/flake\.hh$''
            ''^subprojects/libexpr/flake/flakeref\.cc$''
            ''^subprojects/libexpr/flake/flakeref\.hh$''
            ''^subprojects/libexpr/flake/lockfile\.cc$''
            ''^subprojects/libexpr/flake/lockfile\.hh$''
            ''^subprojects/libexpr/flake/url-name\.cc$''
            ...
            ''^subprojects/libstore/ssh-store-config\.hh$''
            ...
            ''^subprojects/libutil/environment-variables\.cc$''
